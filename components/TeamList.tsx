    ...
    return (
        <section className="mb-10">
            <div className="flex items-center mb-6">
                <div className={`w-3 h-8 bg-gradient-to-b ${color} rounded-full mr-3`}></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {teams.map((team, idx) => (
                    ...
                    >
                        <div className={`w-2 h-2 bg-gradient-to-r ${color} rounded-full mr-3 group-hover:scale-150 transition-transform`}></div>
